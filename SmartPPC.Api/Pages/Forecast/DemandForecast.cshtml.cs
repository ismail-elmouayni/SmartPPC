...
namespace SmartPPC.Api.Pages.Forecast;

public class DemandForecastModel : PageModel
{
    private readonly ConfigurationService _configService;
    private readonly ILogger<DemandForecastModel> _logger;

    public DemandForecastModel(ConfigurationService configService, ILogger<DemandForecastModel> logger)
    {
